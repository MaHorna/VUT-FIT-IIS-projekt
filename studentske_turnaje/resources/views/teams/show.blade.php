...
* AUTHOR : Dávid Kán - xkanda01 --}}
    ...
    <x-layout>
        ...
        {{-- Script for pop up edit team form --}}
        <script>
            var opened = 0;
            var id_name = 'modal';
        ...
        {{-- Script for pop up delete team form --}}
        <script>
            var opened = 0;
        ...
        {{-- Script for pop up add player form --}}
        <script>
            var opened = 0;
            var id_name = 'modal';
                                ...
                                <div id="forEachPlayers" class="rounded bg-grayish p-2">
                                    @foreach($team_users as $team_user)
                                        <div id="div{{$team->id .'a'. $team_user->id}}" style="display: visible;">
                                            ...
                                            {{-- Ajax script delete user form team --}}
                                            <script>
