    ...
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="{{url('/tournaments')}}" enctype="multipart/form-data" id="tournamentForm">
            ...
            <div class="mb-6">
                ...
                >
                <select id="logo" name="logo" form="tournamentForm" class="border border-gray-200 bg-grayish rounded p-2 w-full" onchange="document.getElementById('logoForm').src = document.getElementById('dom-target').textContent+'/'+this.value">
